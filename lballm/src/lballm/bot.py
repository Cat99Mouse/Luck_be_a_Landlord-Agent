...
class Bot:
    ...
    def __init__(self, config: Config) -> None:
        ...
        self._pending_storage_snapshot: dict[str, Any] | None = None
        self._last_storage_snapshot_spin: Any = None
    ...
    async def _call_game(
        ...
        *,
        ...
        try:
            ...
            if method == "spin":
                self._pending_storage_snapshot = None
            self.trace.write(
                "action_error",
                step=step,
                source=source,
    ...
    def _begin_spin_tracking(
        ...
        *,
        ...
        if not self._is_gamestate(gamestate):
            return
        self._pending_storage_snapshot = {
            "step": step,
            "source": source,
    ...
    def _maybe_write_storage_inventory_snapshot(
        ...
        *,
        ...
        pending = self._pending_storage_snapshot
        ...
        if spins is not None and spins == self._last_storage_snapshot_spin:
            self._pending_storage_snapshot = None
            return
        ...
        self._last_storage_snapshot_spin = spins
        self._pending_storage_snapshot = None
